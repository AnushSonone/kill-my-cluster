...
const (
	...
	KV_CAS_FullMethodName         = "/kvpb.KV/CAS"
	KV_ExecuteOnce_FullMethodName = "/kvpb.KV/ExecuteOnce"
	KV_Checkpoint_FullMethodName  = "/kvpb.KV/Checkpoint"
	KV_Watch_FullMethodName       = "/kvpb.KV/Watch"
)
...
type KVClient interface {
	...
	ExecuteOnce(ctx context.Context, in *ExecuteOnceRequest, opts ...grpc.CallOption) (*ExecuteOnceResponse, error)
...
func (c *kVClient) ExecuteOnce(ctx context.Context, in *ExecuteOnceRequest, opts ...grpc.CallOption) (*ExecuteOnceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExecuteOnceResponse)
	err := c.cc.Invoke(ctx, KV_ExecuteOnce_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kVClient) Checkpoint(ctx context.Context, in *CheckpointRequest, opts ...grpc.CallOption) (*CheckpointResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckpointResponse)
	err := c.cc.Invoke(ctx, KV_Checkpoint_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KVServer interface {
	...
	ExecuteOnce(context.Context, *ExecuteOnceRequest) (*ExecuteOnceResponse, error)
...
func (UnimplementedKVServer) ExecuteOnce(context.Context, *ExecuteOnceRequest) (*ExecuteOnceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExecuteOnce not implemented")
}
func (UnimplementedKVServer) Checkpoint(context.Context, *CheckpointRequest) (*CheckpointResponse, error) {
...
func _KV_ExecuteOnce_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecuteOnceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KVServer).ExecuteOnce(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KV_ExecuteOnce_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KVServer).ExecuteOnce(ctx, req.(*ExecuteOnceRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _KV_Checkpoint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckpointRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KVServer).Checkpoint(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KV_Checkpoint_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KVServer).Checkpoint(ctx, req.(*CheckpointRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KV_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ExecuteOnce",
			Handler:    _KV_ExecuteOnce_Handler,
		},
		{
			MethodName: "Checkpoint",
			Handler:    _KV_Checkpoint_Handler,
		},
	},
